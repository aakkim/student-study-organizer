...
from .forms import ConversionForm, ConversionLengthForm, ConversionMassForm, HomeworkForm, NoteForm, DashboardForm, TodoForm, UserRegistrationForm
...
class NotesDetailView(generic.DetailView):
    model = Note
    template_name = 'main/notes_detail.html'
        ...
        for i in video.result()['result']:
            ...
            if i['descriptionSnippet']:
                for j in i['descriptionSnippet']:
                    descript += j['text']
            result_dict['description'] = descript
...
def todo(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            todos.save()
            messages.success(request, f'Added to To-Do list successfully!')
    else:
        form = TodoForm()
    ...
    if request.method == 'POST':
        ...
        for i in range(10):
            result_dict = {
                ...
                'author': answer['items'][i]['volumeInfo'].get('authors')[0],
...
def conversion(request):
    ...
    return render(request, 'main/conversion.html', context)
